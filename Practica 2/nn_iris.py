...
for i in xrange(epoch):
    for qq in xrange(len(x_data_test) / batch_size):
        batch_test_xs = x_data_test[qq * batch_size: qq * batch_size + batch_size]
        batch_test_ys = y_data_test[qq * batch_size: qq * batch_size + batch_size]
...
graph_test, = mp.plot(test_errors)
graph_valid, = mp.plot(valid_errors)
graph_train, = mp.plot(train_errors)

mp.legend(handles=[graph_train, graph_valid, graph_test],
